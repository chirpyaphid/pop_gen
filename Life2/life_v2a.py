...
class organism:
    def __init__(self, genotype, name='', phenotypes=[]):
        ...
        self.state = 1
        self.repoductive_age = 250
        self.life_exp = random.randint(200, 2000)
        self.age = 0
        self.gen = 0
        self.offspring = 0
        self.pollination_count = 0
        self.max_pollination_count = 0
        self.max_pollination = 10
                            ...
                            if len(organisms) > base['STARTING_POP'] * 15:
                                ...
                                for child in offspring:
                                    if [('A', 'a'), ('B', 'B'), ('C', 'c')] == child.genotype:
                                        child.repoductive_age = 20
                                        child.location.width = child.location.width * 5
                                    ...
                                    child.location.x = g.location.x + random.randint(-base['ORGANISM_SIZE'] * 2,
                                                                                     base['ORGANISM_SIZE'] * 2)
                                    child.location.y = g.location.y + random.randint(-base['ORGANISM_SIZE'] * 2,
                                                                                     base['ORGANISM_SIZE'] * 2)
